(() => {
  ...
  const initialize = () => {
    ...
    hamburger.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
  ...
  function loadRobotChatScript() {
    if (!document.getElementById("robot-chat-script")) {
      ...
      s.src = "robot-chat.js?v=mse745p9";
